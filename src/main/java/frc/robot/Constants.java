...
public final class Constants {
    ...
    public static final class FiringSolutions {
        ...
        public static final FiringSolution autoBall5 = new FiringSolution(3200, 4100, 4200, 1.25, 160); // needs
                                                                                                        // calibration
    ...
    public static final class DriveConstants {
        ...
        public static final double autoRotationMaxSpeed = Constants.demo.inDemoMode ? Constants.demo.rotationScaleFactor
