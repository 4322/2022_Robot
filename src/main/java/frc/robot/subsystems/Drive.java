  ...
  public void init() {
    if (Constants.driveEnabled) {
      ...
      if (Constants.driveEnabled) {
        ...
        swerveModules[WheelPosition.FRONT_LEFT.wheelNumber].follow(
          swerveModules[WheelPosition.FRONT_RIGHT.wheelNumber].getDrive(),
          "Front Left Following"
        );
        swerveModules[WheelPosition.BACK_LEFT.wheelNumber].follow(
          swerveModules[WheelPosition.FRONT_RIGHT.wheelNumber].getDrive(),
          "Back Left Following"
        );
        swerveModules[WheelPosition.BACK_RIGHT.wheelNumber].follow(
          swerveModules[WheelPosition.FRONT_RIGHT.wheelNumber].getDrive(),
